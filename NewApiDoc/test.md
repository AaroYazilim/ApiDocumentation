...
⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃
## End-point: Tamamlanmis Uretim Maliyetleri
Üretimi tamamlanan reçetelerin maliyetleri görüntülendiği alandır.
### Method: GET
>```
>{{BaseUrl}}/api/urIsEmri/TamamlanmisUretimMaliyetleri
>```
### Body (**raw**)
